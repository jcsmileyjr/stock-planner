...
export default function InputNumber ({label, property, data, disableInput = false, description}: {label: string, property: string, data: number, disableInput:boolean, description: string}) {
    ...
    return (
        <div className="flex flex-col mb-2">    
            ...
            <input
                ...
                className={`border-2 border-slate-500 rounded-md p-1 mb-2 ${disableInput ? "bg-slate-500 text-slate-500 " : "bg-white text-black"}`}
